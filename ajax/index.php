...
<body>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="radio" name="jenis_kelamin" id="jenkel1" value="L" required="true"> Laki-laki <input type="radio" name="jenis kelamin" id="jenkel2" value="p"> Perempuan
                    </div>
    ...
    <script type="text/javascript">
        ...
        $("#simpan").click(function() {
            ...
            if (nama != "" && alamat != "" &&
                (document.getElementById("jenkel1").checked || document.getElementById("jenkel2").checked) &&
                no_telp != "") {
